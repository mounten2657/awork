...
function main()
{
    ...
    $username = '3302220083';
    $password = '4365074063';
    $url = 'https://qian.pubwinol.com/Login/Login.do';
    $params = [];
    ...
    //第二步 获取网吧信息
    $url = 'https://qian.pubwinol.com/ucenter/accountSafe.do';
    $params = [];
    ...
    //拿uuid
    $url = 'https://qian.pubwinol.com/Qdd/gamedesk.do';
    $params = [];
    $data =  Http::get($url,$params,$header,true);
...
class Http
{
    ...
    {
        $domain = 'http://yun.xiaobaibar.net/proxy?proxy_url='.$url;
        echo $domain."<br><br>";
        return $domain;
    }
